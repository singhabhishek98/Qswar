    ...
    <nav className={`fixed top-0 w-full bg-white z-50 transition-all ${scrolled ? 'shadow-lg' : ''}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
        ...
        <div className="flex gap-4 sm:gap-8 items-center">
          ...
          <a href="#contact" className="hidden md:inline text-gray-600 hover:text-purple-600 font-medium transition">Contact</a>
          <button className="bg-linear-to-r from-blue-800 to-purple-600 text-white px-4 sm:px-7 py-2 sm:py-3 rounded-lg font-semibold hover:-translate-y-1 hover:shadow-xl transition-all">
            Get Started
          </button>
        </div>
      </div>
